...
public class LoginPage extends BasePage {
    ...
    private final By LOGIN_PAGE_MESSAGE_TEXT_LOCATOR = By.className("error-text");
    ...
    public CheckBox getKeepMeLoggedCheckBox() {
        return new CheckBox(driver, KEEP_ME_LOGGED_CHECKBOX_LOCATOR);
    }
